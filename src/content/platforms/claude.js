// Fast GPTZero - Claude Content Script

console.log('Fast GPTZero: Claude content script loaded');
...
function init() {
  observeMessages();
  console.log('Fast GPTZero: Initialized for Claude');
}
...
function addButtonsToMessages() {
  // Claude uses specific selectors for assistant messages
  ...
  messageSelectors.forEach(selector => {
    ...
    messages.forEach(message => {
      ...
      const isUserMessage = message.closest('[data-is-user-message="true"]') ||
      ...
      // Find the text content area - look for the actual message content
      const contentArea = message.querySelector('[class*="content"], .prose, p') || message;
...
function addCheckButton(messageElement, contentArea) {
  ...
  // Insert after message element or at the end
...
function handleRevisionRequest() {
  ...
  // Find the input area - Claude uses contenteditable divs
